...
}]};try{var x=function(){"use strict";for(var n=document.getElementsByTagName("script"),p=0;p<n.length;p++)if(n[p].src.match(/(jquery\.facedetection(\.min)?\.js)|\/ccv\.js/))return n[p].src},y=x()}catch(n){}if(void 0===i){var i=function(n,p){"use strict";return i.core[p.toString()]=p().core,function(){var n,z,x,y;if(arguments.length>1)for(z=arguments[arguments.length-2],x=arguments[arguments.length-1],y=new Array(arguments.length-2),n=0;n<arguments.length-2;n++)y[n]=arguments[n];else z=arguments[0].async,x=arguments[0].worker,y=arguments[0],delete y.async,delete y.worker,y=[y];var i={shared:{}},e=p.apply(i,y);return z?function(z,s){var t=0,a=new Array(x),r=e.pre.apply(i,[x]);for(n in i.shared)"function"==typeof i.shared[n]?delete i.shared[n]:void 0!==i.shared[n].tagName&&delete i.shared[n];for(n=0;x>n;n++){var l=new Worker(h);l.onmessage=function(n){return function(p){a[n]="string"==typeof p.data?JSON.parse(p.data):p.data,t++,t==x&&z(e.post.apply(i,[a]))}}(n);var o={input:r[n],name:p.toString(),shared:i.shared,id:n,worker:y.worker_num};try{l.postMessage(o)}catch(h){l.postMessage(JSON.stringify(o))}}}:e.post.apply(i,[[e.core.apply(i,[e.pre.apply(i,[1])[0],0,1])]])}};i.core={}}var e={pre:function(n){if("img"==n.tagName.toLowerCase()){var p=document.createElement("canvas");document.body.appendChild(n),p.width=n.offsetWidth,p.style.width=n.offsetWidth.toString()+"px",p.height=n.offsetHeight,p.style.height=n.offsetHeight.toString()+"px",document.body.removeChild(n);var z=p.getContext("2d");return z.drawImage(n,0,0),p}return n},grayscale:function(n){for(var p,z,x=n.getContext("2d"),y=x.getImageData(0,0,n.width,n.height),i=y.data,e=n.width*n.height*4;e>0;)i[e-=4]=i[p=e+1]=i[z=e+2]=.3*i[e]+.59*i[p]+.11*i[z];return x.putImageData(y,0,0),n},array_group:function(n,p){var z,x,y=new Array(n.length);for(z=0;z<n.length;z++)y[z]={parent:-1,element:n[z],rank:0};for(z=0;z<n.length;z++)if(y[z].element){for(var i=z;-1!=y[i].parent;)i=y[i].parent;for(x=0;x<n.length;x++)if(z!=x&&y[x].element&&p(y[z].element,y[x].element)){for(var e=x;-1!=y[e].parent;)e=y[e].parent;if(e!=i){y[i].rank>y[e].rank?y[e].parent=i:(y[i].parent=e,y[i].rank==y[e].rank&&y[e].rank++,i=e);for(var s,t=x;-1!=y[t].parent;)s=t,t=y[t].parent,y[s].parent=i;for(t=z;-1!=y[t].parent;)s=t,t=y[t].parent,y[s].parent=i}}}var a=new Array(n.length),r=0;for(z=0;z<n.length;z++){x=-1;var l=z;if(y[l].element){for(;-1!=y[l].parent;)l=y[l].parent;y[l].rank>=0&&(y[l].rank=~r++),x=~y[l].rank}a[z]=x}return{index:a,cat:r}},detect_objects:i(y,function(n,z,x,y){function i(n){var p=this.shared.canvas,z=this.shared.interval,x=this.shared.scale,y=this.shared.next,i=this.shared.scale_upto,e=new Array(4*(i+2*y)),s=new Array(4*(i+2*y));e[0]=p,s[0]={width:e[0].width,height:e[0].height,data:e[0].getContext("2d").getImageData(0,0,e[0].width,e[0].height).data};var t;for(t=1;z>=t;t++)e[4*t]=document.createElement("canvas"),e[4*t].width=Math.floor(e[0].width/Math.pow(x,t)),e[4*t].height=Math.floor(e[0].height/Math.pow(x,t)),e[4*t].getContext("2d").drawImage(e[0],0,0,e[0].width,e[0].height,0,0,e[4*t].width,e[4*t].height),s[4*t]={width:e[4*t].width,height:e[4*t].height,data:e[4*t].getContext("2d").getImageData(0,0,e[4*t].width,e[4*t].height).data};for(t=y;i+2*y>t;t++)e[4*t]=document.createElement("canvas"),e[4*t].width=Math.floor(e[4*t-4*y].width/2),e[4*t].height=Math.floor(e[4*t-4*y].height/2),e[4*t].getContext("2d").drawImage(e[4*t-4*y],0,0,e[4*t-4*y].width,e[4*t-4*y].height,0,0,e[4*t].width,e[4*t].height),s[4*t]={width:e[4*t].width,height:e[4*t].height,data:e[4*t].getContext("2d").getImageData(0,0,e[4*t].width,e[4*t].height).data};for(t=2*y;i+2*y>t;t++)e[4*t+1]=document.createElement("canvas"),e[4*t+1].width=Math.floor(e[4*t-4*y].width/2),e[4*t+1].height=Math.floor(e[4*t-4*y].height/2),e[4*t+1].getContext("2d").drawImage(e[4*t-4*y],1,0,e[4*t-4*y].width-1,e[4*t-4*y].height,0,0,e[4*t+1].width-2,e[4*t+1].height),s[4*t+1]={width:e[4*t+1].width,height:e[4*t+1].height,data:e[4*t+1].getContext("2d").getImageData(0,0,e[4*t+1].width,e[4*t+1].height).data},e[4*t+2]=document.createElement("canvas"),e[4*t+2].width=Math.floor(e[4*t-4*y].width/2),e[4*t+2].height=Math.floor(e[4*t-4*y].height/2),e[4*t+2].getContext("2d").drawImage(e[4*t-4*y],0,1,e[4*t-4*y].width,e[4*t-4*y].height-1,0,0,e[4*t+2].width,e[4*t+2].height-2),s[4*t+2]={width:e[4*t+2].width,height:e[4*t+2].height,data:e[4*t+2].getContext("2d").getImageData(0,0,e[4*t+2].width,e[4*t+2].height).data},e[4*t+3]=document.createElement("canvas"),e[4*t+3].width=Math.floor(e[4*t-4*y].width/2),e[4*t+3].height=Math.floor(e[4*t-4*y].height/2),e[4*t+3].getContext("2d").drawImage(e[4*t-4*y],1,1,e[4*t-4*y].width-1,e[4*t-4*y].height-1,0,0,e[4*t+3].width-2,e[4*t+3].height-2),s[4*t+3]={width:e[4*t+3].width,height:e[4*t+3].height,data:e[4*t+3].getContext("2d").getImageData(0,0,e[4*t+3].width,e[4*t+3].height).data};return[s]}function s(n,p,z){var x,y,i,e,s,t,a=this.shared.cascade,r=(this.shared.interval,this.shared.scale),l=this.shared.next,o=this.shared.scale_upto,h=1,c=1,d=[0,1,0,1],g=[0,0,1,1],f=[];for(x=0;o>x;x++){var w=n[4*x+8*l].width-Math.floor(a.width/4),u=n[4*x+8*l].height-Math.floor(a.height/4),v=[4*n[4*x].width,4*n[4*x+4*l].width,4*n[4*x+8*l].width],m=[16*n[4*x].width-16*w,8*n[4*x+4*l].width-8*w,4*n[4*x+8*l].width-4*w];for(y=0;y<a.stage_classifier.length;y++){var $=a.stage_classifier[y].orig_feature,C=a.stage_classifier[y].feature=new Array(a.stage_classifier[y].count);for(i=0;i<a.stage_classifier[y].count;i++)for(C[i]={size:$[i].size,px:new Array($[i].size),pz:new Array($[i].size),nx:new Array($[i].size),nz:new Array($[i].size)},t=0;t<$[i].size;t++)C[i].px[t]=4*$[i].px[t]+$[i].py[t]*v[$[i].pz[t]],C[i].pz[t]=$[i].pz[t],C[i].nx[t]=4*$[i].nx[t]+$[i].ny[t]*v[$[i].nz[t]],C[i].nz[t]=$[i].nz[t]}for(t=0;4>t;t++){var b=[n[4*x].data,n[4*x+4*l].data,n[4*x+8*l+t].data],B=[8*d[t]+g[t]*n[4*x].width*8,4*d[t]+g[t]*n[4*x+4*l].width*4,0];for(s=0;u>s;s++){for(e=0;w>e;e++){var O=0,k=!0;for(y=0;y<a.stage_classifier.length;y++){O=0;var _=a.stage_classifier[y].alpha,C=a.stage_classifier[y].feature;for(i=0;i<a.stage_classifier[y].count;i++){var M,I,D=C[i],N=b[D.pz[0]][B[D.pz[0]]+D.px[0]],A=b[D.nz[0]][B[D.nz[0]]+D.nx[0]];if(A>=N)O+=_[2*i];else{var S,T=!0;for(S=0;S<D.size;S++){if(D.pz[S]>=0&&(M=b[D.pz[S]][B[D.pz[S]]+D.px[S]],N>M)){if(A>=M){T=!1;break}N=M}if(D.nz[S]>=0&&(I=b[D.nz[S]][B[D.nz[S]]+D.nx[S]],I>A)){if(I>=N){T=!1;break}A=I}}O+=T?_[2*i+1]:_[2*i]}}if(O<a.stage_classifier[y].threshold){k=!1;break}}k&&f.push({x:(4*e+2*d[t])*h,y:(4*s+2*g[t])*c,width:a.width*h,height:a.height*c,neighbor:1,confidence:O}),B[0]+=16,B[1]+=8,B[2]+=4}B[0]+=m[0],B[1]+=m[1],B[2]+=m[2]}}h*=r,c*=r}return f}function t(n){var p,z,x=this.shared.min_neighbors,y=this.shared.cascade;for(this.shared.interval,this.shared.scale,this.shared.next,this.shared.scale_upto,p=0;p<y.stage_classifier.length;p++)y.stage_classifier[p].feature=y.stage_classifier[p].orig_feature;if(n=n[0],x>0){var i=e.array_group(n,function(n,p){var z=Math.floor(.25*n.width+.5);return p.x<=n.x+z&&p.x>=n.x-z&&p.y<=n.y+z&&p.y>=n.y-z&&p.width<=Math.floor(1.5*n.width+.5)&&Math.floor(1.5*p.width+.5)>=n.width}),s=i.cat,t=i.index,a=new Array(s+1);for(p=0;p<a.length;p++)a[p]={neighbors:0,x:0,y:0,width:0,height:0,confidence:0};for(p=0;p<n.length;p++){var r=n[p],l=t[p];0==a[l].neighbors&&(a[l].confidence=r.confidence),++a[l].neighbors,a[l].x+=r.x,a[l].y+=r.y,a[l].width+=r.width,a[l].height+=r.height,a[l].confidence=Math.max(a[l].confidence,r.confidence)}var o=[];for(p=0;s>p;p++){var h=a[p].neighbors;h>=x&&o.push({x:(2*a[p].x+h)/(2*h),y:(2*a[p].y+h)/(2*h),width:(2*a[p].width+h)/(2*h),height:(2*a[p].height+h)/(2*h),neighbors:a[p].neighbors,confidence:a[p].confidence})}var c=[];for(p=0;p<o.length;p++){var r=o[p],d=!0;for(z=0;z<o.length;z++){var g=o[z],f=Math.floor(.25*g.width+.5);if(p!=z&&r.x>=g.x-f&&r.y>=g.y-f&&r.x+r.width<=g.x+g.width+f&&r.y+r.height<=g.y+g.height+f&&(g.neighbors>Math.max(3,r.neighbors)||r.neighbors<3)){d=!1;break}}d&&c.push(r)}return c}return n}if(void 0!==this.shared){var a=p(arguments,["canvas","cascade","interval","min_neighbors"]);this.shared.canvas=a.canvas,this.shared.interval=a.interval,this.shared.min_neighbors=a.min_neighbors,this.shared.cascade=a.cascade,this.shared.scale=Math.pow(2,1/(a.interval+1)),this.shared.next=a.interval+1,this.shared.scale_upto=Math.floor(Math.log(Math.min(a.canvas.width/a.cascade.width,a.canvas.height/a.cascade.height))/Math.log(this.shared.scale));var r;for(r=0;r<this.shared.cascade.stage_classifier.length;r++)this.shared.cascade.stage_classifier[r].orig_feature=this.shared.cascade.stage_classifier[r].feature}return{pre:i,core:s,post:t}})};onmessage=function(n){var p="string"==typeof n.data?JSON.parse(n.data):n.data,z={shared:p.shared},x=i.core[p.name].apply(z,[p.input,p.id,p.worker]);try{postMessage(x)}catch(n){postMessage(JSON.stringify(x))}},n.fn.faceDetection=function(p){"use strict";var x,y={interval:4,minNeighbors:1,grayscale:!0,confidence:null,async:!1,complete:function(){},error:function(){}};return n.isFunction(p)?y.complete=p:n.extend(y,p),this.each(function(){function p(){var n,p;if(x=(new Date).getTime(),s.is("img"))n=new Image,n.src=s.attr("src"),n.crossOrigin=s.attr("crossorigin"),p=e.pre(n);else if(s.is("video")||s.is("canvas")){var t,a;n=s[0],t=document.createElement("canvas"),t.setAttribute("width",n.videoWidth||n.width),t.setAttribute("height",n.videoHeight||n.height),a=t.getContext("2d"),a.drawImage(n,0,0),p=e.pre(t)}y.grayscale&&(p=e.grayscale(p));try{y.async&&window.Worker?e.detect_objects({canvas:p,cascade:z,interval:y.interval,min_neighbors:y.minNeighbors,worker:1,async:!0})(i):i(e.detect_objects({canvas:p,cascade:z,interval:y.interval,min_neighbors:y.minNeighbors}))}catch(n){y.error.apply(s,[2,n.message]),y.complete.apply(s,[!1])}}function i(n){for(var p=n.length,z=[],i=0;p>i;++i)null!==y.confidence&&n[i].confidence<=y.confidence||(n[i].positionX=a.left+n[i].x,n[i].positionY=a.top+n[i].y,n[i].offsetX=t.left+n[i].x,n[i].offsetY=t.top+n[i].y,n[i].scaleX=r,n[i].scaleY=l,z.push(n[i]));z.time=(new Date).getTime()-x,y.complete.apply(s,[z])}var s=n(this),t=s.offset(),a=s.position(),r=s.width()/(this.naturalWidth||this.videoWidth)||1,l=s.height()/(this.naturalHeight||this.videoHeight)||1;return s.is("img, video, canvas")?p():(y.error.apply(s,[1,"Face detection is possible on images, videos and canvas only."]),void y.complete.apply(s,[[]]))})}}("function"==typeof jQuery?jQuery:"function"==typeof Zepto?Zepto:{fn:{}}),$(document).ready(function(){function n(n){var p=n.offset().top,z=n.offset().left,x={top:p-$(window).scrollTop(),left:z-$(window).scrollLeft()};return x}var p='<div class="pixelarity-img-edit"><canvas class="pixelarity-img-edit-can"> </canvas><canvas class="pixelarity-img-edit-process-can"></canvas><div class="pixelarity-img-edit-select"><div class="pixelarity-img-edit-select-resize"></div></div> <div id="pixelarity-side-opt-holder"> <div class="pixelarity-side-opt pixelarity-active-side-opt" id="pixelarity-side-opt-crop"> Crop </div> <div class="pixelarity-side-opt" id="pixelarity-side-opt-draw"> Draw </div> <div class="pixelarity-side-opt" id="pixelarity-side-opt-filter"> Filters </div> </div>  <div id="pixelarity-filter-opt-cont"><div class="pixelarity-filter-opt pixelarity-active-filter-opt" id="pixelarity-filter-opt-1">None</div><div class="pixelarity-filter-opt" id="pixelarity-filter-opt-2">Grayscale</div><div class="pixelarity-filter-opt" id="pixelarity-filter-opt-3">Chrome</div><div class="pixelarity-filter-opt" id="pixelarity-filter-opt-4">Nova</div><div class="pixelarity-filter-opt" id="pixelarity-filter-opt-5">Blur</div></div>  <div id="pixelarity-draw-opt-color-cont"><div class="pixelarity-draw-opt-color" id="pixelarity-draw-opt-color-1"></div><div class="pixelarity-draw-opt-color" id="pixelarity-draw-opt-color-2"></div><div class="pixelarity-draw-opt-color pixelarity-active-draw-opt-color" id="pixelarity-draw-opt-color-3"></div><div class="pixelarity-draw-opt-color" id="pixelarity-draw-opt-color-4"></div><div class="pixelarity-draw-opt-color" id="pixelarity-draw-opt-color-5"></div><div class="pixelarity-draw-opt-color" id="pixelarity-draw-opt-color-6"></div></div> <div class="pixelarity-img-edit-act pixelarity-img-edit-save"> Done </div><div class="pixelarity-img-edit-act pixelarity-img-edit-cancel"> Cancel </div></div>';$("body").append(p),window.pixelarity={can:$(".pixelarity-img-edit-can")[0],ctx:null,processCan:$(".pixelarity-img-edit-process-can")[0],selectionBox:$(".pixelarity-img-edit-select"),container:$(".pixelarity-img-edit"),saveBtn:$(".pixelarity-img-edit-save"),cancelBtn:$(".pixelarity-img-edit-cancel"),sideOpts:$(".pixelarity-side-opt"),sideOptCrop:$("#pixelarity-side-opt-crop"),sideOptDraw:$("#pixelarity-side-opt-draw"),sideOptFilter:$("#pixelarity-side-opt-filter"),drawOptsColorsContainer:$("#pixelarity-draw-opt-color-cont"),drawOptsColors:$(".pixelarity-draw-opt-color"),drawOptColor1:$("#pixelarity-draw-opt-color-1"),drawOptColor1:$("#pixelarity-draw-opt-color-2"),drawOptColor1:$("#pixelarity-draw-opt-color-3"),drawOptColor1:$("#pixelarity-draw-opt-color-4"),drawOptColor1:$("#pixelarity-draw-opt-color-5"),drawOptColor1:$("#pixelarity-draw-opt-color-6"),filterOptsContainer:$("#pixelarity-filter-opt-cont"),filterOpts:$(".pixelarity-filter-opt"),filterOptNone:$("#pixelarity-filter-opt-1"),filterOptGray:$("#pixelarity-filter-opt-2"),filterOptChrome:$("#pixelarity-filter-opt-3"),filterOptNova:$("#pixelarity-filter-opt-4"),filterOptBlur:$("#pixelarity-filter-opt-5"),face:!1,drag:!1,resize:!1,square:!0,status:!1,grcx:null,grcy:null,callback:null,imageType:null,imageQuality:1,tool:"crop",drawing:!1,colors:["000000","ffffff","2795f3","ec5454","2ecc71","efd244"],drawColor:"2795f3",open:function(n,p,z,x,y,i){if(n.constructor!==File||!n.type.match("image.*"))return!1;this.drag=!1,this.resize=!1,this.face=i||!1,this.changeTool("crop"),this.square=p===!0?!0:!1,this.imageQuality=Number(y)>0&&Number(y)<=1?Number(y):1,"jpeg"==x||"png"==x||"gif"==x||"bmp"==x?this.imageType=x:this.imageType="jpeg",this.grcx=!1,this.grcy=!1;var e={};this.callback=z&&"[object Function]"===e.toString.call(z)?z:!1,this.status=!0,this.ctx=this.can.getContext("2d"),pixelarity.container.css("display","block").stop().animate({opacity:"1"});var s=new Image,t=this;return $(s).on("load",function(){s.width>s.height?(t.can.width=s.width,t.can.height=s.height,t.can.style.width=$(window).width()/2*1+"px",t.can.style.height=s.height*($(window).width()/2*1/s.width)+"px",pixelarity.ctx.fillStyle="#fff",pixelarity.ctx.fillRect(0,0,t.can.width,t.can.height),pixelarity.ctx.drawImage(s,0,0,t.can.width,t.can.height),pixelarity.selectionBox.height($(t.can).height()-20),pixelarity.selectionBox.width($(t.can).height()-20),pixelarity.selectionBox.css({left:$(window).width()/2-$(t.can).height()/2+10+"px",top:$(window).height()/2-$(t.can).height()/2-15+"px"})):s.width<s.height?(t.can.width=s.width,t.can.height=s.height,t.can.style.width=s.width*($(window).height()/3*2/s.height)+"px",t.can.style.height=$(window).height()/3*2+"px",pixelarity.ctx.fillStyle="#fff",pixelarity.ctx.fillRect(0,0,t.can.width,t.can.height),pixelarity.ctx.drawImage(s,0,0,t.can.width,t.can.height),pixelarity.selectionBox.height($(t.can).width()-20),pixelarity.selectionBox.width($(t.can).width()-20),pixelarity.selectionBox.css({left:$(window).width()/2-$(t.can).width()/2+10+"px",top:$(window).height()/2-$(t.can).width()/2-15+"px"})):(t.can.width=s.width,t.can.height=s.height,t.can.style.width=$(window).height()/4.8*3.3+"px",t.can.style.height=$(window).height()/4.8*3.3+"px",pixelarity.ctx.fillStyle="#fff",pixelarity.ctx.fillRect(0,0,t.can.width,t.can.height),pixelarity.ctx.drawImage(s,0,0,t.can.width,t.can.height),pixelarity.selectionBox.height($(t.can).width()-20),pixelarity.selectionBox.width($(t.can).width()-20),pixelarity.selectionBox.css({left:$(window).width()/2-$(t.can).width()/2+10+"px",top:$(window).height()/2-$(t.can).width()/2-15+"px"}));var n=pixelarity.can.width/$(pixelarity.can).width(),p=pixelarity.can.height*n,z=pixelarity.can.width*n;pixelarity.processCan.height=p,pixelarity.processCan.width=z;var x=pixelarity.processCan.getContext("2d");x.drawImage(pixelarity.can,0,0,z,p)}),s.src=URL.createObjectURL(n),!0},changeTool:function(n){return"crop"==n?(this.selectionBox.css("display","block"),this.tool="crop",this.sideOpts.removeClass("pixelarity-active-side-opt"),this.sideOptCrop.addClass("pixelarity-active-side-opt"),this.drawOptsColorsContainer.css("display","none"),this.filterOptsContainer.css("display","none"),!0):"draw"==n?(this.tool="draw",this.sideOpts.removeClass("pixelarity-active-side-opt"),this.sideOptDraw.addClass("pixelarity-active-side-opt"),this.selectionBox.css("display","none"),this.filterOptsContainer.css("display","none"),this.drawOptsColorsContainer.css("display","block"),!0):void("filter"==n&&(this.tool="filter",this.sideOpts.removeClass("pixelarity-active-side-opt"),this.sideOptFilter.addClass("pixelarity-active-side-opt"),this.drawOptsColorsContainer.css("display","none"),this.selectionBox.css("display","none"),this.filterOptsContainer.css("display","block")))},changeFilter:function(n){pixelarity.filterOpts.removeClass("pixelarity-active-filter-opt"),$("#pixelarity-filter-opt-"+n).addClass("pixelarity-active-filter-opt"),1==n?pixelarity.ctx.filter="none":2==n?pixelarity.ctx.filter="grayscale(1)":3==n?pixelarity.ctx.filter="sepia(0.42) saturate(1.4) contrast(1.1)":4==n?pixelarity.ctx.filter="grayscale(0.25) saturate(0.75) contrast(1.5)":5==n&&(pixelarity.ctx.filter="blur(14px)"),this.ctx.height=this.ctx.height,this.ctx.drawImage(pixelarity.processCan,0,0,pixelarity.can.width,pixelarity.can.height)},close:function(){this.drag=!1,this.resize=!1,this.square=!0,this.status=!1,this.grcx=void 0,this.grcy=void 0,this.callback=void 0,this.can.height=0,this.can.width=0,this.processCan.height=0,this.processCan.width=0,pixelarity.ctx.filter="none",pixelarity.filterOpts.removeClass("pixelarity-active-filter-opt"),pixelarity.filterOptNone.addClass("pixelarity-active-filter-opt");var n=this.processCan.getContext("2d");pixelarity.ctx.clearRect(0,0,0,0),n.clearRect(0,0,0,0),pixelarity.selectionBox.css({height:"0px",width:"0px"}),pixelarity.container.stop().animate({opacity:"0"},300),setTimeout(function(){pixelarity.container.css({display:"none"})},300)}},$(document).on("mouseup",function(){pixelarity.drag=!1,pixelarity.resize=!1,pixelarity.grcx=!1,pixelarity.grcy=!1,pixelarity.drawing=!1}),pixelarity.selectionBox.on("mousedown",function(p){var z=$(this),x=p.clientX-n(z).left,y=p.clientY-n(z).top;pixelarity.grcx=!1,pixelarity.grcy=!1,pixelarity.selectionBox.width()-x<=28&&pixelarity.selectionBox.height()-y<=28?(pixelarity.drag=!1,pixelarity.resize=!0):(pixelarity.drag=!0,pixelarity.resize=!1)}),$(pixelarity.can).on("mousedown",function(p){if("draw"==pixelarity.tool){pixelarity.drawing=!0;var z=pixelarity.can.width/$(pixelarity.can).width();pixelarity.lastDrawX=(p.clientX-n($(pixelarity.can)).left)*z,pixelarity.lastDrawY=(p.clientY-n($(pixelarity.can)).top)*z}}),$(document).on("mousemove",function(p){var z=p.clientX-n(pixelarity.selectionBox).left,x=p.clientY-n(pixelarity.selectionBox).top;if(pixelarity.drag===!0&&pixelarity.status){pixelarity.grcx===!1&&(pixelarity.grcx=z),pixelarity.grcy===!1&&(pixelarity.grcy=x);var y=p.clientX-pixelarity.grcx,i=p.clientY-pixelarity.grcy;y+pixelarity.selectionBox.width()>=$(pixelarity.can).width()+n($(pixelarity.can)).left||y<=n($(pixelarity.can)).left?y<=n($(pixelarity.can)).left?pixelarity.selectionBox.css({left:n($(pixelarity.can)).left+"px"}):pixelarity.selectionBox.css({left:n($(pixelarity.can)).left+$(pixelarity.can).width()-pixelarity.selectionBox.width()+"px"}):pixelarity.selectionBox.css({left:y+"px"}),i+pixelarity.selectionBox.height()>=$(pixelarity.can).height()+n($(pixelarity.can)).top||i<=n($(pixelarity.can)).top?i<=n($(pixelarity.can)).top?pixelarity.selectionBox.css({top:n($(pixelarity.can)).top+"px"}):pixelarity.selectionBox.css({top:n($(pixelarity.can)).top+$(pixelarity.can).height()-pixelarity.selectionBox.height()+"px"}):pixelarity.selectionBox.css({top:i+"px"})}else if(pixelarity.resize===!0&&pixelarity.status){var e=z,s=x;pixelarity.square?(e>=s?(s=e,100>e&&(e=100,s=100)):(e=s,100>s&&(e=100,s=100)),e+n(pixelarity.selectionBox).left>=$(pixelarity.can).width()+n($(pixelarity.can)).left?(e=n($(pixelarity.can)).left+$(pixelarity.can).width()-n(pixelarity.selectionBox).left,n(pixelarity.selectionBox).top+e>$(pixelarity.can).height()+n($(pixelarity.can)).top&&(e=n($(pixelarity.can)).top+$(pixelarity.can).height()-n(pixelarity.selectionBox).top),s=e):s+n(pixelarity.selectionBox).top>=$(pixelarity.can).height()+n($(pixelarity.can)).top&&(s=n($(pixelarity.can)).top+$(pixelarity.can).height()-n(pixelarity.selectionBox).top,n(pixelarity.selectionBox).left+s>$(pixelarity.can).width()+n($(pixelarity.can)).left&&(s=n($(pixelarity.can)).left+$(pixelarity.can).width()-n(pixelarity.selectionBox).left),e=s)):(100>=e&&(e=100),100>=s&&(s=100),p.clientX>=$(pixelarity.can).width()+n($(pixelarity.can)).left&&(e=n($(pixelarity.can)).left+$(pixelarity.can).width()-n(pixelarity.selectionBox).left),p.clientY>=$(pixelarity.can).height()+n($(pixelarity.can)).top&&(s=n($(pixelarity.can)).top+$(pixelarity.can).height()-n(pixelarity.selectionBox).top)),pixelarity.selectionBox.css({width:e+"px",height:s+"px"})}else if(pixelarity.drawing&&pixelarity.status){var t=pixelarity.can.width/$(pixelarity.can).width(),a=(p.clientX-n($(pixelarity.can)).left)*t,r=(p.clientY-n($(pixelarity.can)).top)*t,l=21;pixelarity.ctx.fillStyle="#"+pixelarity.drawColor;var o=pixelarity.processCan.getContext("2d");o.fillStyle="#"+pixelarity.drawColor;for(var y=(a-pixelarity.lastDrawX)/l,i=(r-pixelarity.lastDrawY)/l,h=1;l>=h;h++)pixelarity.ctx.beginPath(),pixelarity.ctx.arc(a-y*h,r-i*h,3*t,0,2*Math.PI,!1),pixelarity.ctx.fill(),o.beginPath(),o.arc((a-y*h)*t,(r-i*h)*t,t*t*3,0,2*Math.PI,!1),o.fill();pixelarity.lastDrawX=a,pixelarity.lastDrawY=r}}),pixelarity.saveBtn.on("click",function(){if(!pixelarity.callback)return void pixelarity.close();"crop"!=pixelarity.tool&&pixelarity.changeTool("crop");var p=pixelarity.can.width/$(pixelarity.can).width(),z=pixelarity.selectionBox.height()*p,x=pixelarity.selectionBox.width()*p,y=(n(pixelarity.selectionBox).left-n($(pixelarity.can)).left)*p,i=(n(pixelarity.selectionBox).top-n($(pixelarity.can)).top)*p;pixelarity.processCan.height=z,pixelarity.processCan.width=x;var e=pixelarity.processCan.getContext("2d");e.drawImage(pixelarity.can,y,i,x,z,0,0,x,z),pixelarity.face?$(pixelarity.processCan).faceDetection({complete:function(n){for(var p=[],z=0;z<n.length;z++)p.push({x:n[z].x,y:n[z].y,height:n[z].x,width:n[z].width});pixelarity.callback(pixelarity.processCan.toDataURL("image/"+pixelarity.imageType,pixelarity.imageQuality),p)}}):pixelarity.callback(pixelarity.processCan.toDataURL("image/"+pixelarity.imageType,pixelarity.imageQuality)),pixelarity.close()}),pixelarity.cancelBtn.on("click",function(){pixelarity.close()}),pixelarity.sideOpts.click(function(){var n=$(this).attr("id").substr(20);pixelarity.changeTool(n)}),$(window).on("resize",function(){pixelarity.status&&pixelarity.selectionBox.css({left:$(window).width()/2-$(pixelarity.can).height()/2+10+"px",top:$(window).height()/2-$(pixelarity.can).height()/2+10+"px"})}),pixelarity.drawOptsColors.on("click",function(){var n=Number($(this).attr("id").substr(26))-1;pixelarity.drawColor=pixelarity.colors[n],pixelarity.drawOptsColors.removeClass("pixelarity-active-draw-opt-color"),$(this).addClass("pixelarity-active-draw-opt-color")}),pixelarity.filterOpts.on("click",function(){var n=Number($(this).attr("id").substr(22));pixelarity.changeFilter(n)})});